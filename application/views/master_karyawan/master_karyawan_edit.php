      ...
      <div class="">
        <div class="row">
          ...
          <?php foreach ($karyawan as $value) ?>
                ...
                <h2 class="card-title"><b>EDIT KARYAWAN</b></h2>
                <br><hr>
              ...
              <!-- /.card-header -->
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="card card-secondary">
                        ...
                        <!-- <form id="form-edit" method="POST" action="<?= base_url(); ?>master_karyawan/proses_edit/" enctype="multipart/form-data"> -->
                          <div class="card-body">
                            <div class="form-group">
                              <img src="<?= base_url(''.$value['img_karyawan'].''); ?>" alt="Photo 3" class="img-fluid" width="50%">
                              <br><br>
                              <input type="file" name="img_karyawan" />
                              <br><br>
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" name="no_karyawan" class="form-control" value="<?php echo $value['no_karyawan'] ?>">
                            </div>
                            ...
                            <div class="form-group">
                              <label>Alamat</label>
                              <textarea name="alamat" class="form-control" rows="3" placeholder="Tuliskan alamat anda .."><?php echo $value['alamat'] ?></textarea>
                            </div>
                          ...
                          <div class="card-footer">
                            <a class="btn btn-default btn-sm" href="<?php echo base_url() . 'master_karyawan'; ?>"> Kembali</a>
...
$(document).ready(function() {
  ...
  $('#form_validasi').on('submit', function(e) {
      ...
      var btn = $('#submit');
      $.ajax({
          url: '<?= base_url(); ?>master_karyawan/proses_edit/', //nama action script php sobat
              ...
              if (data['error']) {
                  ...
                  swal("Success!", "Data berhasil diupdate", "success")
                      .then((value) => {
                          ...
                          window.location.href = "<?= base_url('master_karyawan/'); ?>";
                      });
              } else {
