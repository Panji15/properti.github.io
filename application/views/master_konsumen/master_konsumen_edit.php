                        ...
                        <!-- <form id="form-edit" method="POST" action="<?= base_url(); ?>master_konsumen/proses_edit/"> -->
                          <div class="card-body">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" name="harga_pengikat" id="rupiah2" class="form-control" value="<?php echo rupiah($value['harga_pengikat']) ?>" required>
                            </div>

                            <div class="form-group">
                              <label for="exampleInputPassword1">Booking Fee</label>
                              <input type="text" name="booking_fee" id="rupiah1" class="form-control" value="<?php echo rupiah($value['booking_fee']) ?>" required>
                            </div>

                            <div class="form-group">
                              <label for="exampleInputPassword1">Tanda Jadi</label>
                              <input type="text" name="tanda_jadi" id="rupiah4" class="form-control" value="<?php echo rupiah($value['tanda_jadi']) ?>" required>
                            </div>

                            <div class="form-group">
                              <label for="exampleInputPassword1">Uang Muka (DP)</label>
                              <input type="text" name="uang_muka" id="rupiah5" class="form-control" value="<?php echo rupiah($value['uang_muka']) ?>" required>
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" name="cicilan" id="rupiah3" class="form-control" value="<?php echo rupiah($value['cicilan']) ?>" required>
                            </div>

                            <!-- <div class="form-group">
                              <label for="exampleInputPassword1">Tenggat Waktu Cicilan</label>
                              <input type="date" name="tenggat_waktu" id="rupiah5" class="form-control" value="<?php echo $value['tenggat_waktu'] ?>" required>
                            </div> -->
